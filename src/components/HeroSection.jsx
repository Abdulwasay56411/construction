...
const HeroSection = () => {
  return (
    <div id='home' className='bg-[url("/herobg.png")] bg-cover bg-center bg-[#111111F2] overflow-hidden'>
      {/* Hero Section */}
      <div className='w-full h-160 lg:h-210 flex flex-col justify-center px-5 md:px-8 lg:px-10 max-w-350 mx-auto'>
        ...
        >
          ...
          <span className='text-[9px] sm:text-[13px] font-medium text-[#D48E26]'>SAUDI ARABIA'S #1 SKILLED MANPOWER PROVIDER</span>
        </motion.div>
        ...
        >
          <h1 className='heading font-black text-[34px] sm:text-5xl md:text-6xl lg:text-7xl leading-12 sm:leading-16 md:leading-18 lg:leading-22 text-[#FFFFFF]'>
            Building Saudi Arabia with <span className='text-[#D48E26]'>Skilled Workforce</span> Excellence
          </h1>
          <p className='max-w-80 sm:max-w-160 py-3 text-[#FFFFFF] text-[10px] sm:text-lg font-light'>
            Providing highly skilled manpower, engineering professionals, construction workforce and contracting solutions across Saudi Arabia with quality, safety and reliability.
          </p>
        </motion.div>
