        ...
        <motion.div
           ...
           <Heading text1={'FAQ'} text2={'Frequently Asked Questions'} para={'Everything you need to know about our manpower supply and contracting services.'}/>
            ...
            <div className='flex flex-col items-center py-5'>
                ...
                <button className='flex justify-center items-center gap-2 bg-[#D48E26] text-[#FFFFFF] rounded-xl w-38.75 h-11.75 mt-5 cursor-pointer'>Contact Us <FaArrowRight size={15}/></button>
            </div>
        </motion.div>
    )
}
